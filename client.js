...
var N, ambient, animate, ballGeometry, ballMeshes, ballShape, balls, boxBody, boxGeometry, boxMesh, boxMeshes, boxShape, boxbody, boxes, c1, c2, camera, cannon, controls, dt, fpscontrols, geometry, groundBody, groundShape, halfExtents, he, hub, i, last, light, mass, material, mesh, physicsContactMaterial, physicsMaterial, renderer, scene, shootDirection, shootVelo, size, solver, space, sphereBody, sphereShape, stats, three, time, world, x, y, z;
...
window.addEventListener('click', function(e) {
  ...
  return ballMesh.position.set(x, y, z);
});
